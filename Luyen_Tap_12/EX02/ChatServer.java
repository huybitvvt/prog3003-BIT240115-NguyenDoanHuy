...
public class ChatServer {
    ...
    public static void main(String[] args) {
        System.out.println("WebSocket Server chạy tại ws://localhost:" + PORT);
    ...
    public static void broadcast(String message) {
        for (ClientHandler client : clients) {
            try {
                ...
                System.out.println("lỗi gửi đến client.");
            }
        }
    }
    ...
    static class ClientHandler implements Runnable {
        ...
        public void run() {
            try {
                ...
                System.out.println("1 client đã kết nối");
                ...
                System.out.println("Client đã ngắt knoi");
            } finally {
                clients.remove(this);
                try {
                    socket.close();
        ...
        private String readMessage(InputStream in) throws IOException {
            ...
            if (payloadLength == 126) {
                ...
                throw new IOException("Payload lớn");
            }
        ...
        public void sendMessage(String message) throws IOException {
            ...
            if (data.length <= 125) {
                ...
                throw new IOException("Tin nhắn dài");
            }
